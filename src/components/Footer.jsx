    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.75 }}>
      ...
      <Box
        sx={{
          position: 'relative',
          bgcolor: TAIL_BG,
          border: '1px solid rgba(242,100,51,0.1)',
      ...
      >
        ...
        >
          <Typography sx={{ fontSize: 10, fontWeight: 500, color: 'rgba(238,243,205,0.22)' }}>
            10:11
          </Typography>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Check size={10} color="#F26433" strokeWidth={2.5} aria-hidden />
            <Box sx={{ ml: '-5px' }}>
              <Check size={10} color="#F26433" strokeWidth={2.5} aria-hidden />
            </Box>
          </Box>
    ...
    >
      ...
      <Typography
        ...
        sx={{
          ...
          lineHeight: 1,
          color: 'transparent',
          WebkitTextStroke: '1px rgba(238,243,205,0.028)',
          whiteSpace: 'nowrap',
          pointerEvents: 'none',
          userSelect: 'none',
          zIndex: 0,
      ...
      <Box
        ...
        sx={{
          ...
          maxHeight: 620,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(242,100,51,0.045) 0%, transparent 65%)',
          filter: 'blur(80px)',
          pointerEvents: 'none',
          zIndex: 0,
        }}
      ...
      <Box
        ...
        sx={{
          ...
          maxHeight: 440,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(242,100,51,0.042) 0%, transparent 65%)',
          filter: 'blur(70px)',
          pointerEvents: 'none',
          zIndex: 0,
        }}
      ...
      >
        ...
        <Box
          sx={{
            height: '1px',
            background:
              'linear-gradient(90deg, transparent, rgba(238,243,205,0.07) 25%, rgba(238,243,205,0.07) 75%, transparent)',
          }}
        />
        ...
        <Box
          sx={{
            height: '1px',
            background:
              'linear-gradient(90deg, transparent, rgba(238,243,205,0.05) 25%, rgba(238,243,205,0.05) 75%, transparent)',
          }}
        />
            ...
            {[
              ...
              <Box
                ...
                sx={{
                  fontSize: 12,
                  fontWeight: 500,
                  color: 'rgba(238,243,205,0.22)',
                  textDecoration: 'none',
                  transition: 'color 0.2s ease',
                  '&:hover': { color: 'rgba(238,243,205,0.52)' },
                }}
              >
                {label}
              </Box>
